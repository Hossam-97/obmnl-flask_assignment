...
def get_transactions():
    total_balance_value = calculate_total_balance(transactions)
...
def search_transactions():
    if request.method == 'POST':
        ...
        # Pass the filtered transactions to the template
...
def total_balance():
    total_balance_value = calculate_total_balance(transactions)
    return f"Total Balance: {total_balance_value}"


def calculate_total_balance(transactions_list):
    total_balance = sum(transaction['amount'] for transaction in transactions_list)
